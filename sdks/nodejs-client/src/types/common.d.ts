export declare const DEFAULT_BASE_URL = "https://api.dify.ai/v1";
export declare const DEFAULT_TIMEOUT_SECONDS = 60;
export declare const DEFAULT_MAX_RETRIES = 3;
export declare const DEFAULT_RETRY_DELAY_SECONDS = 1;
export type RequestMethod = "GET" | "POST" | "PATCH" | "PUT" | "DELETE";
export type QueryParamValue = string | number | boolean | Array<string | number | boolean> | undefined;
