...
export declare enum ModelModeType {
    chat = "chat",
    completion = "completion",
    unset = ""
}
export declare enum RETRIEVE_TYPE {
    oneWay = "single",
    multiWay = "multiple"
}
export declare enum RETRIEVE_METHOD {
...
export declare const AppModes: readonly [AppModeEnum.COMPLETION, AppModeEnum.WORKFLOW, AppModeEnum.CHAT, AppModeEnum.ADVANCED_CHAT, AppModeEnum.AGENT_CHAT];
/**
 * Variable type
 */
export declare const VariableTypes: readonly ["string", "number", "select"];
...
export declare enum TtsAutoPlay {
    enabled = "enabled",
    disabled = "disabled"
}
export declare const ALLOW_FILE_EXTENSIONS: string[];
