export declare enum SSOProtocol {
    SAML = "saml",
    OIDC = "oidc",
    OAuth2 = "oauth2"
}
...
export declare enum InstallationScope {
    ALL = "all",
    NONE = "none",
...
export declare const defaultSystemFeatures: SystemFeatures;
export declare enum DatasetAttr {
