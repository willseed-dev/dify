...
export declare enum PipelineInputVarType {
...
export declare const VAR_TYPE_MAP: Record<PipelineInputVarType, BaseFieldType>;
...
export declare enum OnlineDriveFileType {
    file = "file",
    folder = "folder",
    bucket = "bucket"
}
