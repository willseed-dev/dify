...
export declare enum DatasetPermission {
    onlyMe = "only_me",
...
export declare const DocumentIndexingStatusList: readonly ["waiting", "parsing", "cleaning", "splitting", "indexing", "paused", "error", "completed"];
export type DocumentIndexingStatus = typeof DocumentIndexingStatusList[number];
export declare const DisplayStatusList: readonly ["queuing", "indexing", "paused", "error", "available", "enabled", "disabled", "archived"];
...
export declare const CUSTOMIZABLE_DOC_TYPES: readonly ["book", "web_page", "paper", "social_media_post", "personal_document", "business_document", "im_chat_log"];
export declare const FIXED_DOC_TYPES: readonly ["synced_from_github", "synced_from_notion", "wikipedia_entry"];
...
export declare const SEGMENT_STATUS_LIST: string[];
...
export declare enum WeightedScoreEnum {
    SemanticFirst = "semantic_first",
    KeywordFirst = "keyword_first",
    Customized = "customized"
}
export declare enum RerankingModeEnum {
    RerankingModel = "reranking_model",
    WeightedScore = "weighted_score"
}
export declare const DEFAULT_WEIGHTED_SCORE: {
...
export declare const DOC_FORM_ICON_WITH_BG: Record<ChunkingMode | 'external', React.ComponentType<{
    className: string;
}>>;
export declare const DOC_FORM_ICON: Record<ChunkingMode.text | ChunkingMode.qa | ChunkingMode.parentChild, React.ComponentType<{
    className: string;
}>>;
type ChunkingModeText = I18nKeysByPrefix<'dataset', 'chunkingMode.'>;
export declare const DOC_FORM_TEXT: Record<ChunkingMode, ChunkingModeText>;
