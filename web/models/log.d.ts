...
export declare const CompletionParams: readonly ["temperature", "top_p", "presence_penalty", "max_token", "stop", "frequency_penalty"];
...
export declare const MessageRatings: readonly ["like", "dislike", null];
...
export declare enum WorkflowRunTriggeredFrom {
    DEBUGGING = "debugging",
    APP_RUN = "app-run",
