...
export declare enum SelfHostedPlan {
    community = "community",
    premium = "premium",
    enterprise = "enterprise"
}
...
export type UsagePlanInfo = Pick<PlanInfo, 'buildApps' | 'teamMembers' | 'annotatedResponse' | 'documentsUploadQuota' | 'apiRateLimit' | 'triggerEvents'> & {
    vectorSpace: number;
};
...
export declare enum DocumentProcessingPriority {
    standard = "standard",
    priority = "priority",
    topPriority = "top-priority"
}
