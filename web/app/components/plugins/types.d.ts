...
export declare enum PluginCategoryEnum {
    tool = "tool",
    model = "model",
    extension = "extension",
...
export type PluginToolDeclaration = {
    ...
    credentials_schema: ToolCredential[];
};
...
export declare enum SupportedCreationMethods {
    OAUTH = "OAUTH",
    APIKEY = "APIKEY",
    MANUAL = "MANUAL"
}
...
export declare enum InstallStepFromGitHub {
    setUrl = "url",
...
export declare enum InstallStep {
    uploading = "uploading",
    uploadFailed = "uploadFailed",
    readyToInstall = "readyToInstall",
