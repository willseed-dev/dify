...
export declare const MODEL_TYPE_TEXT: {
    llm: string;
...
export declare enum ModelFeatureTextEnum {
    toolCall = "Tool Call",
    multiToolCall = "Multi Tool Call",
    agentThought = "Agent Thought",
    vision = "Vision",
...
export declare const MODEL_STATUS_TEXT: {
    [k: string]: TypeWithI18N;
};
export declare enum CustomConfigurationStatusEnum {
    active = "active",
    noConfigure = "no-configure"
}
...
export declare enum PreferredProviderTypeEnum {
    system = "system",
    custom = "custom"
}
export declare enum CurrentSystemQuotaTypeEnum {
    trial = "trial",
    free = "free",
    paid = "paid"
}
export declare enum QuotaUnitEnum {
    times = "times",
    tokens = "tokens",
    credits = "credits"
}
...
export declare enum ModelModalModeEnum {
