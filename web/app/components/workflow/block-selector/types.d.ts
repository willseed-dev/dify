...
export declare enum TabsEnum {
    Start = "start",
    Blocks = "blocks",
    Tools = "tools",
    Sources = "sources"
}
export declare enum ToolTypeEnum {
    All = "all",
    BuiltIn = "built-in",
    Custom = "custom",
    Workflow = "workflow",
...
export declare enum BlockClassificationEnum {
    Default = "-",
...
export type TriggerParameter = {
    ...
    label: TypeWithI18N;
    description?: TypeWithI18N;
    type: 'string' | 'number' | 'boolean' | 'select' | 'file' | 'files' | 'model-selector' | 'app-selector' | 'object' | 'array' | 'dynamic-select';
    auto_generate?: {
        type: string;
        value?: unknown;
    } | null;
...
export type TriggerCredentialField = {
    type: 'secret-input' | 'text-input' | 'select' | 'boolean' | 'app-selector' | 'model-selector' | 'tools-selector';
    name: string;
    scope?: string | null;
    required: boolean;
...
export declare enum TriggerCredentialTypeEnum {
    ApiKey = "api-key",
    Oauth2 = "oauth2",
