import type { CommonNodeType, ModelConfig, Node, NodeOutPutVar, ValueSelector } from '@/app/components/workflow/types';
...
export declare enum MetadataFilteringModeEnum {
    disabled = "disabled",
    automatic = "automatic",
    manual = "manual"
}
export declare enum MetadataFilteringVariableType {
    string = "string",
    number = "number",
    time = "time",
    select = "select"
