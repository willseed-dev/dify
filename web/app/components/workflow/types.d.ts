...
import type { DefaultValueForm, ErrorHandleTypeEnum } from '@/app/components/workflow/nodes/_base/components/error-handle/types';
...
export declare enum InputVarType {
...
export declare enum EditionType {
    basic = "basic",
    jinja2 = "jinja2"
}
...
export declare enum MemoryRole {
    user = "user",
    assistant = "assistant"
}
...
export type NodeDefault<T = {}> = {
    ...
    checkValid: (payload: T, t: any, moreDataForCheckValid?: any) => {
        isValid: boolean;
        errorMessage?: string;
    };
...
export declare enum WorkflowRunningStatus {
    Waiting = "waiting",
    Running = "running",
    Succeeded = "succeeded",
    Failed = "failed",
...
export declare enum WorkflowVersion {
    Draft = "draft",
    Latest = "latest"
}
...
export type OnNodeAdd = (newNodePayload: {
    nodeType: BlockEnum;
    sourceHandle?: string;
    targetHandle?: string;
...
export declare enum SupportUploadFileTypes {
    image = "image",
    document = "document",
    audio = "audio",
    video = "video",
...
export declare enum WorkflowVersionFilterOptions {
    all = "all",
    onlyYours = "onlyYours"
}
export declare enum VersionHistoryContextMenuOptions {
    restore = "restore",
    edit = "edit",
    delete = "delete",
    exportDSL = "exportDSL",
...
export declare const TRIGGER_NODE_TYPES: readonly [BlockEnum.TriggerSchedule, BlockEnum.TriggerWebhook, BlockEnum.TriggerPlugin];
export type TriggerNodeType = typeof TRIGGER_NODE_TYPES[number];
export declare function isTriggerNode(nodeType: BlockEnum): boolean;
export type Block = {
